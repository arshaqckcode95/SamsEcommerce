          ...
          <View style={{alignItems:"center",margin:5}}>
            <Card style={styles.paymentCard}>
             <CardItem style={styles.itemStyle}>
                <View style={{flexDirection:"row",justifyContent:"space-between"}}>
                 ...
                 <Text style={{marginLeft:5,fontSize:15}}>Shipping Address</Text>
                </View>
            ...
            <CardItem style={styles.itemStyle}>
                <View style={{flexDirection:"row",justifyContent:"space-between"}}>
                 ...
                 <Text style={{marginLeft:5,fontSize:15}}>Payment Method</Text>
                </View>
              <View style={{justifyContent:"center"}}>
                <View style={{width:20,height:20,borderRadius:25/2,backgroundColor:"#d3d3d3" ,alignItems:"center",justifyContent:"center"}}>
                   <Icon name="chevron-right"
                ...
                <View style={{flexDirection:"row",justifyContent:"space-between"}}>
                 ...
                 <Text style={{marginLeft:5,fontSize:15}}>Currency</Text>
                </View>
              <View style={{justifyContent:"center"}}>
                <View style={{width:20,height:20,borderRadius:25/2,backgroundColor:"#d3d3d3" ,alignItems:"center",justifyContent:"center"}}>
                   <Icon name="chevron-right"
                ...
                <View style={{flexDirection:"row",justifyContent:"space-between"}}>
                 ...
                 <Text style={{marginLeft:5,fontSize:15}}>Language</Text>
                </View>
              <View style={{justifyContent:"center"}}>
                <View style={{width:20,height:20,borderRadius:25/2,backgroundColor:"#d3d3d3" ,alignItems:"center",justifyContent:"center"}}>
                   <Icon name="chevron-right"
